    ...
    pub fn items(&self) -> Vec<ItemType> {
        match self {
            ...
            ItemGroup::Statues => vec![ItemType::StatuePillar1,
                ...
                ItemType::StatueAnd,
                ItemType::StatueAt,
                ItemType::StatueDrone,
                ItemType::StatueSniper,
                ItemType::StatueHover,
                ItemType::StatueCat,
                ItemType::StatueQuadMech,
                ItemType::StatueCommander,
                ItemType::StatueTrooper,
                ItemType::StatueMech,
                ItemType::StatueMiner,
                ItemType::StatueMastodon,
                ItemType::StatueMultiDrone,
                ItemType::StatueSpearman,
                ItemType::StatueBall,
                ItemType::StatueBigfoot,
                ItemType::StatueNoble,
                ItemType::StatueReaper,
                ItemType::StatueSnail,
                ItemType::StatueBlade,
                ItemType::StatueGunship,
                ItemType::StatueTriangle,
                ItemType::StatueScientist,
                ItemType::StatueHologram,],
            ItemGroup::Other => vec![],
        }
    }
...
impl ItemType {
    pub fn sprite_row_and_col(&self) -> (usize, usize) {
        match self {
            ...
            ItemType::StatueDrone => (19, 28),
            ItemType::StatueSniper => (19, 29),
            ItemType::StatueHover => (19, 30),
            ItemType::StatueCat => (19, 31),
            ItemType::StatueQuadMech => (19, 32),
            ItemType::StatueCommander => (19, 33),
            ItemType::StatueTrooper => (19, 34),
            ItemType::StatueMech => (19, 35),
            ItemType::StatueMiner => (19, 36),
            ItemType::StatueMastodon => (19, 37),
            ItemType::StatueMultiDrone => (19, 38),
            ItemType::StatueSpearman => (19, 39),
            ItemType::StatueBall => (19, 40),
            ItemType::StatueBigfoot => (19, 41),
            ItemType::StatueNoble => (19, 42),
            ItemType::StatueReaper => (19, 43),
            ItemType::StatueSnail => (19, 44),
            ItemType::StatueBlade => (19, 45),
            ItemType::StatueGunship => (19, 46),
            ItemType::StatueTriangle => (19, 47),
            ItemType::StatueScientist => (19, 48),
            ItemType::StatueHologram => (19, 49),
            ItemType::Moss1 => (51, 3),
            ItemType::Moss2 => (51, 4),
            ItemType::Moss3 => (51, 5),
            ItemType::Moss4 => (51, 6),
